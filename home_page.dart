...
void saveNewTask(){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.blue, //.fromARGB(255, 215, 201, 45),//color for background of app
      appBar: AppBar(
        title: Text("AGGIES DO! ",
        style: TextStyle(
          fontSize: 30,
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/black.png'), // Replace with your background image path
            fit: BoxFit.cover,
